 ...
 */
public class ImgLib2FourierConvolver<T extends RealType<T>, K extends RealType<K>, O extends RealType<O>>
	...
	@Override
	public RandomAccessibleInterval<O> compute(final RandomAccessible<T> in,
		...
		if (m_lastImg != in) {
			m_lastImg = in;
			m_fc = FFTConvolution.create(m_lastImg, out, kernel, kernel, out,
