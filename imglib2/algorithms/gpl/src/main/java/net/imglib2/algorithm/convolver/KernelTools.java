...
public class KernelTools {
        ...
        public static <K extends RealType<K> & NativeType<K>> RandomAccessibleInterval<K>[] decomposeKernel(
                ...
                SingularValueDecomposition svd = isDecomposable(SubsetOperations
        ...
        private static class ImgBasedRealMatrix<TT extends RealType<TT>>
                ...
                public RealMatrix createMatrix(final int rowDimension,
                        ...
                        return new Array2DRowRealMatrix(rowDimension,
                                        columnDimension);
                }
