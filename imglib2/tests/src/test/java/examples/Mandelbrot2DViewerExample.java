...
public class Mandelbrot2DViewerExample< T extends NumericType< T > & NativeType< T > >
{
	private final int width = 800;
	private final int height = 600;

	public Mandelbrot2DViewerExample( final RealRandomAccessible< T > source, final Converter< T, ARGBType > converter )
	{
		/* center shift */
	...
	final static public void main( final String[] args ) throws ImgIOException
	{
		...
		new Mandelbrot2DViewerExample< LongType >( mandelbrot, lut );
	}
