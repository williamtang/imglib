...
//
//		File file = new File(
//				"/Users/tinevez/Projects/MElBeheiry/Data/zstack4a.tif");
//		ImgPlus<T> img;
//		try {
//			img = (ImgPlus<T>) ImgOpener.open(file.getAbsolutePath());
...
//			GaussianPeakFitterND<T> peakFitter = new GaussianPeakFitterND<T>(
//					currentSlice, maxIteration, lambda, termEpsilon);
//			// NB: Calling "new Point(x0, y0)" results in a compile error with
//			// javac.
//			// So we force Javac to use the "Point(int...)" constructor
//			// explicitly.
//			Localizable startPoint = new Point(new int[] { x0, y0 });
//			double[] results = peakFitter.process(startPoint, new double[] {
//					sigma0, sigma0 });
//
//			double A = results[0];
//			double x = results[1];
...
//			System.out
//					.println(String
//							.format("Z = %3d: A = %6.0f, x0 = %6.2f, y0 = %6.2f, sx = %5.2f, sy = %5.2f \t alpha = %6.3f",
//									z, A, x, y, sx, sy, sy / sx));
//
//		}
//
